...
tropopause["temp"] = CalcTemp(
    ...
    troposphere["temp"], troposphere['lapse'])
tropopause["pressure"] = CalcPressure(
    tropopause["geopotential"] - troposphere["geopotential"],
    troposphere["temp"], troposphere["pressure"],  troposphere['lapse'])
...
mid_stratosphere["geopotential"] = CalcGeopotentialHeight(mid_stratosphere["altitude"])# [m]
...
mid_stratosphere["pressure"] = CalcPressure(
    ...
    tropopause["temp"], tropopause["pressure"], tropopause['lapse'])
...
upper_stratosphere["geopotential"] = CalcGeopotentialHeight(upper_stratosphere["altitude"])#[m]
upper_stratosphere["temp"] = CalcTemp(
    upper_stratosphere["geopotential"] - mid_stratosphere["geopotential"],
    mid_stratosphere["temp"], mid_stratosphere['lapse'])
upper_stratosphere["pressure"] = CalcPressure(
    upper_stratosphere["geopotential"] - mid_stratosphere["geopotential"],
    mid_stratosphere["temp"], mid_stratosphere["pressure"], mid_stratosphere['lapse'])
...
stratopause["temp"] = CalcTemp(
    ...
    upper_stratosphere["temp"], upper_stratosphere['lapse'])
stratopause["pressure"] = CalcPressure(
    stratopause["geopotential"] - upper_stratosphere["geopotential"],
    upper_stratosphere["temp"], upper_stratosphere["pressure"], upper_stratosphere['lapse'])
...
mid_mesosphere["geopotential"] = CalcGeopotentialHeight(mid_mesosphere["altitude"]) # [m]
...
mid_mesosphere["pressure"] = CalcPressure(
    ...
    stratopause["temp"], stratopause["pressure"], stratopause['lapse'])
...
upper_mesosphere["geopotential"] = CalcGeopotentialHeight(upper_mesosphere["altitude"]) # [m]
upper_mesosphere["temp"] = CalcTemp(
    upper_mesosphere["geopotential"] - mid_mesosphere["geopotential"],
    mid_mesosphere["temp"], mid_mesosphere['lapse'])
upper_mesosphere["pressure"] = CalcPressure(
    upper_mesosphere["geopotential"] - mid_mesosphere["geopotential"],
    mid_mesosphere["temp"], mid_mesosphere["pressure"], mid_mesosphere['lapse'])
...
def SampleUSStdAtmosphere(Z):
    ...
    pressure = CalcPressure(delta_H, layer["temp"], layer["pressure"], layer["lapse"])
...
geopotential_alts = np.array(
    [CalcGeopotentialHeight(alt) for alt in altitudes]
)
...
ax.semilogx(densities,  geopotential_alts/1000.0,  \
    marker="None", linestyle="-", label="US Std")  
ax.semilogx(densities_api,  geopotential_alts/1000.0,  \
...
ax.plot(temperatures, geopotential_alts/1000.0, 
    marker="None", linestyle="-", label="US Std")  

ax.plot(temps_api, geopotential_alts/1000.0, 
    marker="None", linestyle="--", 
    label="NRLMSISE-00")
...
ax.semilogx(pressures, geopotential_alts/1000.0, 
    marker="None", linestyle="-", label="US Std")  
